...
public class Ville {
	...
	// Elles sont communes à toutes les instances de la classe
	...
	public String comparer(Ville ville) {
		...
		if(ville.nombreHabitants > this.nombreHabitants)
			str = ville.nomVille + " est plus peuplée que " + this.nomVille;
		else
			str = this.nomVille + " est plus peuplée que " + ville.nomVille;
