...
class Commemoratif extends Timbre {
	...
	public Commemoratif(String code, int anneeEmission, String pays) {
		this(code, anneeEmission, pays, VALEUR_TIMBRE_DEFAUT);
	}

	public Commemoratif(String code, int anneeEmission) {
		this(code, anneeEmission, PAYS_DEFAUT, VALEUR_TIMBRE_DEFAUT);
	}
...
class Rare extends Timbre {
	...
	public Rare(String code, int anneeEmission, String pays, int nombreExemplaires) {
		this(code, anneeEmission, pays, VALEUR_TIMBRE_DEFAUT, nombreExemplaires);
	}

	public Rare(String code, int anneeEmission, int nombreExemplaires) {
		this(code, anneeEmission, PAYS_DEFAUT, VALEUR_TIMBRE_DEFAUT, nombreExemplaires);
	}

	public Rare(String code, int nombreExemplaires) {
		this(code, ANNEE_COURANTE, PAYS_DEFAUT, VALEUR_TIMBRE_DEFAUT, nombreExemplaires);
	}
